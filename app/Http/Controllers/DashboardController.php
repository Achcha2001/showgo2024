...
class DashboardController extends Controller
{
    ...
    public function showAddTrainScheduleForm()
    {
        ...
        return view('add-train-schedule')->with('trainSchedules', $trainSchedules);
    }
    ...
    {
        $trainSchedules = TrainSchedule::all();
        return view('train-schedule', ['trainSchedules' => $trainSchedules]);
    }

    public function editTrainSchedule($id)
    {
        $trainSchedule = TrainSchedule::findOrFail($id);
        return view('edit-train-schedule', ['trainSchedule' => $trainSchedule]);
    }
